...
export class ImageUpdateComponent implements OnInit {
  ...
  setFileData(event: Event, field: string, isImage: boolean): void {
    this.dataUtils.loadFileToForm(event, this.editForm, field, isImage).subscribe({
      error: (err: FileLoadError) =>
        this.eventManager.broadcast(new EventWithContent<AlertError>('fbsApp.error', { ...err, key: 'error.file.' + err.key })),
    });
  }
  ...
  protected updateForm(image: IImage): void {
    this.editForm.patchValue({
      ...
      lastModifiedDate: image.lastModifiedDate ? image.lastModifiedDate.format(DATE_TIME_FORMAT) : null,
    });
  }
