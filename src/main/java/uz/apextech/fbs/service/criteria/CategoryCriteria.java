...
/**
 * Criteria class for the {@link uz.apextech.fbs.domain.Category} entity. This class is used
 * in {@link uz.apextech.fbs.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdBy, createdDate, lastModifiedBy, lastModifiedDate, bookId, distinct);
    }
